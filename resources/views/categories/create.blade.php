        ...
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        <h1 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-2">Tambah Kategori Baru</h1>
                        <p class="text-gray-600 text-lg">Buat kategori baru untuk mengelompokkan produk Anda</p>
                    </div>
                ...
                <div
                    ...
                    <div class="bg-gradient-to-r from-green-600 to-emerald-500 px-6 py-4 rounded-t-2xl">
                        <div class="flex items-center justify-between">
                            <h2 class="text-xl font-bold text-white">Formulir Tambah Kategori</h2>
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-white/90 text-sm">Kategori Baru</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Gunakan nama yang deskriptif dan mudah diingat untuk
                                    kategori</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="text-sm font-semibold text-gray-900">Manfaat Kategori</p>
                                <p class="text-xs text-gray-500 mt-1">Memudahkan pengelompokan dan pencarian produk</p>
                            </div>
                        </div>
                    </div>
                </div>
