            ...
            <div class="mb-8">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 text-lg">Perbarui informasi produk {{ $product->name }}</p>
                    </div>
                ...
                <div
                    ...
                    <div class="bg-gradient-to-r from-green-600 to-emerald-500 px-6 py-4 rounded-t-2xl">
                        <div class="flex items-center justify-between">
                            <h2 class="text-xl font-bold text-white">Formulir Edit Produk</h2>
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-white/90 text-sm">ID: {{ $product->id }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('products.update', $product->id) }}" method="POST" class="p-6 space-y-6"
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="description" id="description" rows="4"
                                ...
                                placeholder="Tambahkan deskripsi produk (opsional)">{{ old('description', $product->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-sm mt-1 flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-semibold text-gray-900">{{ $product->created_at->format('d M Y') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-semibold text-gray-900">{{ $product->updated_at->format('d M Y') }}
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div>
                                ...
                                <p class="text-sm font-semibold text-gray-900">
                                    ...
                                    @elseif($product->stock < 10)
                                        <span class="text-yellow-600">Rendah</span>
                                    @else
