        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            ...
            <div class="mb-8">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        <h1 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-2">Edit Lokasi Penyimpanan</h1>
                        <p class="text-gray-600 text-lg">Perbarui informasi lokasi penyimpanan {{ $location->name }}</p>
                    </div>
                ...
                <div
                    ...
                    <div class="bg-gradient-to-r from-green-600 to-emerald-500 px-6 py-4 rounded-t-2xl">
                        <div class="flex items-center justify-between">
                            <h2 class="text-xl font-bold text-white">Formulir Edit Lokasi Penyimpanan</h2>
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-white/90 text-sm">ID: {{ $location->id }}</span>
                            </div>
                        </div>
                    </div>

                    <form action="{{ route('locations.update', $location->id) }}" method="POST" class="p-6 space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="description" id="description" rows="4"
                                ...
                                placeholder="Tambahkan deskripsi lokasi penyimpanan (opsional)">{{ old('description', $location->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-sm mt-1 flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-semibold text-gray-900">{{ $location->created_at->format('d M Y') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-semibold text-gray-900">{{ $location->updated_at->format('d M Y') }}
                                </p>
                            </div>
                        </div>
                    </div>
